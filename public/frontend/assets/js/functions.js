...
var e = {
    ...
    //       if(dir == 'rtl') {
    //           style.setAttribute('href', 'frontend/assets/css/style-dark-rtl.css');
    //       } else {
    //           style.setAttribute('href', 'frontend/assets/css/style-dark.css');
    //       }
    ...
    //       if(dir == 'rtl') {
    //           style.setAttribute('href', 'frontend/assets/css/style-rtl.css');
    //       } else {
    //           style.setAttribute('href', 'frontend/assets/css/style.css');
    //       }
