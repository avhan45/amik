            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="video-player rounded-3 mt-3">
                        <img src="<?php echo e(asset('storage/' . $post->gambar)); ?>" alt="">
                    </div>
                </div>
                <!-- Course video END -->
                        ...
                        <div class="col-12">
                            ...
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item h6 me-3 mb-1 mb-sm-0"><i
                                        class="fas fa-clock text-danger me-2"></i><?php echo e($post->updated_at); ?></li>
                                <li class="list-inline-item h6 me-3 mb-1 mb-sm-0"><i
                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content pt-4 px-3" id="course-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="course-pills-1" role="tabpanel"
                                    ...
                                    <p class="mb-3"><?php echo $post->isi; ?></p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/avhan/Documents/PROJECT/website amik/amik/resources/views/frontend/pengumuman_detail.blade.php ENDPATH**/ ?>