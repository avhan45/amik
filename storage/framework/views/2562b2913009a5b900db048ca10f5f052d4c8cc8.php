                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card bg-transparent">
                            <div class="overflow-hidden rounded-3">
                                <img src="<?php echo e(asset('storage/' . $data->gambar)); ?>" class="card-img" alt="course image">

                                <!-- Overlay -->
                                <div class="bg-overlay bg-dark opacity-4"></div>
                                <div class="card-img-overlay d-flex align-items-start p-3">
                                    <!-- badge -->
                                    <a href="#" class="badge bg-danger text-white">News</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title"><a
                                        href="<?php echo e(url('berita/detail', $data->id)); ?>"><?php echo e($data->judul); ?></a></h5>
                                <p class="text-truncate-2"><?php echo e($data->isi); ?></p>
                                <!-- Info -->
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0"><a href="#">Admin</a></h6>
                                    <span class="small"><?php echo e($data->updated_at); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/avhan/Documents/PROJECT/website amik/amik/resources/views/frontend/berita_list.blade.php ENDPATH**/ ?>