                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <form class="form-horizontal" method="POST" action="<?php echo e(route('berita.update', $berita->id)); ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div id="berita" style="background: transparent !important">
                                                <textarea name="isi" id="isi" class="form-control"><?php echo e(old('isi', $berita->isi)); ?></textarea>
                                                <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/avhan/Documents/PROJECT/LARAVEL/Amik3/resources/views/admin/berita_edit.blade.php ENDPATH**/ ?>