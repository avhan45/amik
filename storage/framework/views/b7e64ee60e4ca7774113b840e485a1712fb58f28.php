                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <form class="form-horizontal" method="post" action="<?php echo e(route('slider.store')); ?>"
...
<?php echo $__env->make('layouts.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/avhan/Documents/PROJECT/LARAVEL/Amik3/resources/views/admin/slider_create.blade.php ENDPATH**/ ?>