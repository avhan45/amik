                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <!-- Content -->
                                            <p class="text-truncate-2 mb-3"><?php echo e($b->isi); ?></p>
                                            <!-- Info -->
                    ...
                    <?php $__currentLoopData = $pengumuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card bg-transparent shadow-lg p-3 bg-body rounded">
                            ...
                            <div class="card-body px-3">
                                ...
                                <p class="text-truncate-2"><?php echo e($p->isi); ?></p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/avhan/Documents/PROJECT/LARAVEL/Amik3/resources/views/frontend/index.blade.php ENDPATH**/ ?>